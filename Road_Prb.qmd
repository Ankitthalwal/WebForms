...
<qgis version="3.22.8-Bia?owie?a">
  <identifier>Topo_Road</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Topo_Road</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Personal GeoDatabase Feature Class" url="file://\\SCIENCE-02\D$\z\Neha_UT_BASE\Master.mdb" size="" format="" mimeType="" type="Local Area Network" description=""/>
  </links>
  <fees></fees>
